...
function DarkMode(){
    ...
    btimg.src = "youtubeClone/imagens/magniffying-dark.png";
    ...
    dot.src = "youtubeClone/imagens/dot-dark.png";
    start.src = "youtubeClone/imagens/home-dark.png";
    explore.src = "youtubeClone/imagens/explore-dark.png";
    subscribe.src = "youtubeClone/imagens/sub-dark.png";
    shorts.src = "youtubeClone/imagens/clock-dark.png";
    ...
    logo.src = "youtubeClone/imagens/youtube-logo-dark.png";
...
function LightMode() {
    ...
    dot.src = "youtubeClone/imagens/dots.png";
    mySidenav.style.backgroundColor = "";
    btimg.src = "youtubeClone/imagens/magnifying-glass.png";
    for (var i = 0; i < nav_bar_op.length; i++) {
    ...
    start.src = "youtubeClone/imagens/home.png";
    explore.src = "youtubeClone/imagens/direction.png";
    subscribe.src = "youtubeClone/imagens/subscribe.png";
    shorts.src = "youtubeClone/imagens/clock.png";
    search_bt.style.transition = "";
    search_bt.style.backgroundColor = "";
    query.style.backgroundColor = "";
    query.style.color = "";
    lateral_icon.style.color = "";
    logo.src = "youtubeClone/imagens/youtube-logo-light.png";
